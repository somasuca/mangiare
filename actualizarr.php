...
$consulta = "UPDATE meseros SET identificacion='$identificacion',nombre='$nombre',codigo='$codigo' WHERE identificacion=$id";
$query =mysqli_query($conect, $consulta);

if ($query) {
    echo "<h1>Se actualizo correctamente el mesero</h1>"."<br>"."<img src=unicornio.png >"."<br>" ;
